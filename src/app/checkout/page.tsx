  ...
  return (
    <div className="mx-auto grid max-w-4xl gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[1fr_1fr]">
      <div>
        ...
        <p className="mt-1 text-sm text-volcanic/60">{t.checkout.guestNotice}</p>
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={pending}
            className="mt-2 rounded-full bg-terracotta px-6 py-4 text-sm font-semibold text-white hover:bg-terracotta-light disabled:opacity-60"
          >
